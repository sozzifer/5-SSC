...
# Generate t distribution for mean (mu), standard deviation (sigma), degrees of freedom (nu) and confidence level (alpha) user entry
def t_distribution(mu, sigma, nu, alpha):
